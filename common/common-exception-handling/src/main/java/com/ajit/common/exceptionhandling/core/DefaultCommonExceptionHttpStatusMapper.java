...
@Component("defaultCommonExceptionHttpStatusMapper")
public class DefaultCommonExceptionHttpStatusMapper implements ExceptionHttpStatusMapper {
	...
	public void initialize(){
		if (this.errorHttpStatusMappingPropFile != null) {
			...
			try {
				...
				if(stream == null){
					stream = DefaultCommonExceptionHttpStatusMapper.class.getClassLoader().getResourceAsStream(errorHttpStatusMappingPropFile);
				}
				if (stream != null) {
