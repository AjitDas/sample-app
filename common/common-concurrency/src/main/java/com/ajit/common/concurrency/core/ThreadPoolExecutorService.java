...
import com.ajit.common.logging.event.SimpleLogEvent;
...
public class ThreadPoolExecutorService {
	...
	private class CommandCallbackThreadPoolExecutor extends ThreadPoolExecutor {
		...
		protected void beforeExecute(Thread thread, Runnable runnable) {
			if(runnable instanceof CallbackAwareCommand<?>){
				...
				((CallbackAwareCommand<?>)runnable).beforeExecute();
			}
		...
		protected void afterExecute(Runnable runnable, Throwable throwable) {
			...
			if(runnable instanceof CallbackAwareCommand<?>){
				...
				((CallbackAwareCommand)runnable).afterExecute(obj, throwable);
			}
		}
