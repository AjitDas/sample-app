...
@Component("slf4jCommonLogger")
public class Slf4jCommonLogger implements CommonLogger {

	private static final Logger logger = LoggerFactory.getLogger(Slf4jCommonLogger.class);
